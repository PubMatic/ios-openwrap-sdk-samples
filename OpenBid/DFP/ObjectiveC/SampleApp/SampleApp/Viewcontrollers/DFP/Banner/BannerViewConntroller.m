...
#import "BannerViewConntroller.h"
...
@interface BannerViewConntroller ()<POBBannerViewDelegate>
@property (nonatomic) POBBannerView *bannerView;
@end

@implementation BannerViewConntroller
...
- (void)viewDidLoad {
    ...
    DFPBannerEventHandler *eventHandler = [[DFPBannerEventHandler alloc] initAdunitId:DFP_AU
                                                                             andSizes:adSizes];
