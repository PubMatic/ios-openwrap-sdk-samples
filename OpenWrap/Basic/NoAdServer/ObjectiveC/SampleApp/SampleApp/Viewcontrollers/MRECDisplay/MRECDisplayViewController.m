...
#import "MRECDisplayViewController.h"
@import OpenWrapSDK;
...
@interface MRECDisplayViewController ()<POBBannerViewDelegate>
@property (nonatomic) POBBannerView *bannerView;
@end

@implementation MRECDisplayViewController
    ...
    self.bannerView = [[POBBannerView alloc] initWithPublisherId:PUB_ID
                                                       profileId:PROFILE_ID
                                                        adUnitId:OW_ADUNIT_ID
                                                         adSizes:@[POBAdSizeMake(300, 250)]];
    // Set the delegate
    self.bannerView.delegate = self;
    
    // Add the banner view to your view hierarchy
    [self addBannerToView:self.bannerView withSize:CGSizeMake(320, 250)];
