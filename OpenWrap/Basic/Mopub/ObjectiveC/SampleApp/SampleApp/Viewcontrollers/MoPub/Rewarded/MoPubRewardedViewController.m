...
#define MOPUB_AD_UNIT   @"bab2e39bd4c149bcb56b4ef759387090"
#define OW_ADUNIT_ID    @"bab2e39bd4c149bcb56b4ef759387090"
#define PUB_ID          @"156276"
#define PROFILE_ID      @1758

@interface MoPubRewardedViewController ()<POBRewardedAdDelegate>
...
- (void)viewDidLoad {
    ...
    MoPubRewardedEventHandler *handler = [MoPubRewardedEventHandler handlerWithAdUnitId:MOPUB_AD_UNIT];
    ...
    self.rewardedAd = [POBRewardedAd rewardedAdWithPublisherId:PUB_ID profileId:PROFILE_ID adUnitId:OW_ADUNIT_ID eventHandler:handler];
...
- (void)showRewardedAd{
    ...
    if (self.rewardedAd.isReady) {
        ...
        NSDictionary *customData = @{
            ...
            kPOBSelectedRewardKey : [self.rewardedAd.availableRewards firstObject]
        };
        // Show Rewarded ad
        [self.rewardedAd showFromViewController:self withCustomData:customData];
    }
}
